...
- [Compiler 2020 Manual](#compiler-2020-manual)
  ...
  * [**文法规则：**](#**文法规则：**)
    ...
    + [**8** **类：**](#**8**-**类：**)
      ...
      - [**8.3 类成员访问**](#**8.3-类成员访问**)
      - [**8.4 类构造函数**](#**8.4-类构造函数**)
      - [**8.5 this指针**](#**8.5-this指针**)
      - [**8.6 类之中的未定义行为**](#**8.6-类之中的未定义行为**)
    + [**9 函数：**](#**9-函数：**)
      - [**9.1 函数定义**](#**9.1-函数定义**)
      - [**9.2 内建函数**](#**9.2-内建函数**)
      - [**9.3 函数返回值**](#**9.3-函数返回值**)
    + [**10 表达式：**](#**10-表达式：**)
      - [**10.1 单目表达式**](#**10.1-单目表达式**)
      - [**10.2 双目表达式**](#**10.2-双目表达式**)
    + [**11 语句：**](#**11-语句：**)
      - [**11.1 变量声明语句**](#**11.1-变量声明语句**)
      - [**11.2 条件语句**](#**11.2-条件语句**)
      - [**11.3 循环语句**](#**11.3-循环语句**)
      - [**11.4 跳转语句**](#**11.4-跳转语句**)
      - [**11.5 表达式语句**](#**11.5-表达式语句**)
    + [**12 字符串：**](#**12-字符串：**)
      - [**12.1 字符串对象**](#**12.1-字符串对象**)
      - [**12.2 字符串的双目运算**](#**12.2-字符串的双目运算**)
      - [**12.3 字符串的内建方法**](#**12.3-字符串的内建方法**)
    + [**13** **作用域：**](#**13**-**作用域：**)
    + [**14** **命名空间：**](#**14**-**命名空间：**)
    + [**15** **左值：**](#**15**-**左值：**)
  * [编译规则：](#编译规则：)
...
Created: 2019-10-13	Last Update: 2020-01-24v6	*Pre-release - v6*
...
特殊的是：自增自减运算符在前缀加意义下表达式返回本身的值`+1`或`-1`的值。后缀加/减返回`void`
